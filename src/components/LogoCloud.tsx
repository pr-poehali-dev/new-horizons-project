...
const companies = [
  ...
  { name: "Концентрация", icon: Diamond },
  { name: "Покой", icon: Circle },
  { name: "Баланс", icon: Hexagon },
  { name: "Ясность", icon: Sparkles },
  { name: "Сила", icon: Star },
  { name: "Осознанность", icon: Globe },
  { name: "Устойчивость", icon: Square },
]
    ...
    <div className="relative z-20 pb-24 pt-8" style={{ backgroundColor: "#09090B" }}>
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-4xl text-center">
          ...
          >
            Развивайте навыки управления собой.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Покой, концентрация, энергия — под вашим контролем.
          </motion.p>
