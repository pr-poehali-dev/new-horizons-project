...
const featureCards = [
  ...
  {
    title: "Энергия и внутренняя сила",
    illustration: (
  ...
  {
    title: "Спокойствие и устойчивость",
    illustration: (
      <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
        <img
...
Что такое управляемые состояния
            ...
            >
              <p className="text-zinc-400 leading-relaxed">
                Управляемые состояния — это навык осознанно входить в нужное психическое
                состояние и управлять своей внутренней энергией. На тренировках вы учитесь
                чувствовать, накапливать и направлять психическую энергию.{" "}
                <a href="#contacts" className="text-white inline-flex items-center gap-1 hover:underline">
